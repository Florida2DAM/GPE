    ...
    render() {
        return (
            <View style={[style.container, style.flexColumnCenter]}>
                ...
                <GPEInput  title={'Total'} placeholder={'0.0€'} width='39%' height={2.5} marginTop='10%'marginRight='2%'  getValue={this.getTotal} />
                <GPEInput  title={'Paid'} placeholder={'0.0€'}  width='39%' height={2.5} marginTop='10%' marginLeft='2%' marginR='30%'  getValue={this.getPaid}/>
                </View>
