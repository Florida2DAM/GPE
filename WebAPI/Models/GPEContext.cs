...
namespace GPE.Models
{
    public class GPEContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Tabla Orders
            modelBuilder.Entity<Order>().HasData(new Order(1, 1, 1, Convert.ToDateTime("2021-02-01 00:00:00"), Convert.ToDateTime("2021-02-02 00:00:00"), 1938.98, false, false, null, 2));
            modelBuilder.Entity<Order>().HasData(new Order(2, 2, 2, Convert.ToDateTime("2021-02-02 00:00:00"), Convert.ToDateTime("2021-02-03 00:00:00"), 2000.98, false, false, null, 2));
